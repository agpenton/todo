...
// item struct represent a ToDo item
type item struct {
	Task        string
	Done        bool
	CreatedAt   time.Time
...
// Add create a new todo item and appends it to the list
...
func (l *List) Complete(i int) error {
	...
	// Adjustung index for 0 based index
	ls[i-1].Done = true
...
//Save method encodes the list as JSON and save it.
// Using the provides filename
